...
export class Tab3Page {
  ...
  constructor(private formBuilder: FormBuilder, private router: Router, private toastCtrl: ToastController, private FirebaseDatabase: FirebaseDatabaseService) {
  ...
  // ["event_title"].value, "this.createEventForm")
    this.FirebaseDatabase.createEvent({event_title: this.createEventForm.controls["event_title"].value, event_category: this.createEventForm.controls["event_category"].value})
